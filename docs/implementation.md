...
| §6.12.1          | Rule purity guards                                                      | OK       | `clippy.toml` + boot tests; [`.github/workflows/ci.yml`](../.github/workflows/ci.yml) (fmt, clippy rules `-D warnings`, clippy workspace, tests). |
