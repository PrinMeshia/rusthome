...
pub use rules_impl::{
    R10_TEMPERATURE_LOG, R11_CONTACT_LOG, R1_MOTION_LIGHT, R2_MOTION_NOTIFY, R3_TURNON_FACT,
    R4_LIGHT_LOG, R5_LOG_USAGE_FACT, R7_TURNOFF_FACT, R8_TEMPERATURE_FACT, R9_CONTACT_FACT,
};
